...
<!-- Header -->
<header id="home" class="header-cart">
 <div class="card-head"> 
  <?php include('includes/main-header.php');?>

  <div class="hero-card">
          <img src="./Images/Hero/test.jpg" alt="" class="hero-img" />
            <div class="preorder">
			<h1>New Arrivals<br></h1>
               <small>Check out the latest accessories<br></small>     
               <a href="#" class="pro">Shop-Now </a> 
            </div>
        </div>
		</div>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<H1>Now you can Get Loan up to 20,000/ Which can pay with 3 month instalment</H1>
...
?>
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
				                <div class="arrows">
				                  <div class="arrow plus gradient"><span class="ir"><i class="fas fa-angle-up"></i></span></div>
				                  <div class="arrow minus gradient"><span class="ir"><i class="fas fa-angle-down"></i></span></div>
				                </div>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						...
						Loan Amount<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalloan". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
