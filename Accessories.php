...
{?>							
    ...
    <a href=""><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="product image" ></a>
    </div>
    ...
    <div class="product-details">
         ...
         <li class="add-cart-button btn-group">
                    ...
                    <a href="Accessories.php?page=product&action=add&id=<?php echo $row['id']; ?>">
            ...
            <?php } ?>
                ...
                <li class="lnk wishlist">
                    <a class="btn-buy" href="Accessories.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" title="Wishlist">
                    Whishlist
                    </a>
                </li>
                        </div>                    
...
<div class="air-pod-new">
        <img src="./Images/watch/hero__gnfk5g59t0qe_xlarge.png" alt="">
        <div class="podmax-text">
            <h1>Airpod max</h1>
            <h2>Introducing AirPods Max — a perfect balance of<br>
                 exhilarating high-fidelity audio and the <br>effortless magic of AirPods. The ultimate <br>
                 personal listening experience is here.</h2>
        </div>
...
{?>							
	<div class="product">
    <div class="img-product-acces">
        
    <a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img class="watch-acces"  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="product image" ></a>
